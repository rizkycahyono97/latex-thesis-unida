\chapter{TINJAUAN PUSTAKA}
	\section{Landasan Teori}
		...
		\subsection{Blockchain dam \textit{Hyperledger Besu}}
		...
		Solidity adalah bahasa pemrograman tingkat tinggi berorientasi object yang dirancang khusus untuk pengembangan \textit{smart contract} pada platform ke blockchain yang kompatible dengan Ethereum Virtual Machine  (\textit{EVM})\footcite{Wood2014}. Penggunaan \textit{Solidity} versi \textit{0.1.19} dalam penelitian ini menjamin stabilitas dan fungsionalitas yang luas terhadap protokol \textit{EVM} pada \textit{Hyperledger Besu}, terutama menghindari penggunaan instruksi (opcode) yang belum didukung oleh konfigurasi jaringan privat blockchain.
