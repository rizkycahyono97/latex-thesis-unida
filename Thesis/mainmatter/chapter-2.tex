\chapter{TINJAUAN PUSTAKA}
	\section{Landasan Teori}
		...
		\newpage
		Integritas pada level data struktur dikelola melalui fungsi \textit{hashStruct} yang didefinisikan pada persamaan~\eqref{eq:eip712-hashstruct}.
		\begin{equation}
		...
		\begin{subsecenumerate}
			...
			\item \textit{encodedData(s)}: Merupakan hasil pengkodean nilai riil dari dokumen yang dikirim menjadi format \textit{32-byte} yang terstandarisasi.
		\end{subsecenumerate}
