\chapter{HASIL DAN PEMBAHASAN}
	...
	\section{Pembahasan}
	Berdarkan hasil implementasi dan pengujian yang telah dilakukan, dapat disimpulkan bahwa sistem verifikasi dokumen akademik berbasis blockchain berhasil dikembangkan sesuai dengan tujuan penelitian. Integrasi antara aplikasi klien, \textit{API Middleware}, \textit{smart contract}, dan jaringan blockchain \textit{Hyperledger Besu} berjalan dengan baik, sehingga proses penerbitan dan verifikasi dokumen dapat dilakukan secara terstuktur. Hasil pengujian \textit{blackbox} menunjukan bahwa seluruh fitur utama sistem telah berfungsi sesuai dengan kebutuhan yang telah ditetapkan.

	Lebih lanjut, implementasi protokol \textit{EIP-712} berhasil memberikan mekanisme autentikasi terhadap proses penerbitan dokumen melalui tanda tangan digital, sedangkan penggunaan \textit{identityHash} dan \textit{fileHash} memungkinkan sistem mendeteksi perubahaan pada file dan metadata berkas melalui perhitungan ulang hash dan pencocokan data yang tersimpan pada blockchain. Selain itu, sistem juga menyediakan dua metode verifikasi, yaitu melalaui \textit{QR Code} dan unggah dokumen PDF.

	Secara keseluruhan, penelitian ini menunjukan bahwa penerapan blockchain menggunakann \textit{Hyperledger Besu} dan protokol \textit{EIP-712} mempu meningkatkan keamanan, integritas, dan keaslian dokumen akademik. Meskipun demikian, sistem yang dikembangkan masih berupa prototipe dan infrastruktur blockchain masih dijalankan pada lingkungan lokal, sehingga penerapan lebih lanjut diperlukan agar dapat diintegrasikan dengan SIAKAD Unida, serta didukung oleh infrastuktur blockchain yang lebih siap diterapkan di lingkungan produksi.
