	...
	\section{Hasil Pengujian Sistem}
		...
		\begin{landscape}
			...
			\begin{table}[ht]
				...
				Transaksi berhasil divalidasi oleh jaringan blockchain sebelum dicatat ke dalam ledger. &
				Seluruh transaksi dokumen memperoleh status \textit{Success} setelah diproses oleh jaringan Hyperledger Besu. &
				Lolos \\ \hline
				...
				Nilai \textit{documentKey}, \textit{identityHash}, dan \textit{fileHash} berhasil disimpan pada \textit{smart contract} dan dapat diambil kembali melalui fungsi \textit{getDocument} di smart contract. &
				Lolos \\ \hline
				...
				Informasi blok dan transaksi ditampilkan secara konsisten pada dashboard Blockscout sebagai representasi data yang tersinkronisasi. &
				Lolos \\ \hline
